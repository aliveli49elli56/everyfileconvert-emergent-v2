...
const CATEGORY_META: Record<FormatCategory, { label: string; color: string }> = {
  ...
  "3d":         { label: "3D",           color: "bg-cyan-100 text-cyan-700" },
  ...
  spreadsheet:  { label: "Spreadsheet",  color: "bg-teal-100 text-teal-700" },
  presentation: { label: "Presentation", color: "bg-orange-100 text-orange-700" },
  ...
  webpage:      { label: "Webpage",      color: "bg-blue-100 text-blue-700" },
  subtitle:     { label: "Subtitle",     color: "bg-gray-100 text-gray-700" },
  certificate:  { label: "Certificate",  color: "bg-yellow-100 text-yellow-700" },
  scientific:   { label: "Scientific",   color: "bg-purple-100 text-purple-700" },
  medical:      { label: "Medical",      color: "bg-red-100 text-red-700" },
  "disk-image": { label: "Disk Image",   color: "bg-gray-100 text-gray-700" },
  executable:   { label: "Executable",   color: "bg-zinc-100 text-zinc-700" },
