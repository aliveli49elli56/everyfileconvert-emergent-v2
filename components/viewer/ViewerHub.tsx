...
const VIEWER_CATEGORY_META: Record<ViewerCategory, { label: string; color: string; gradient: string }> = {
  ...
  cad:          { label: 'CAD',          color: 'text-teal-600',    gradient: 'from-teal-500 to-cyan-500' },
  ...
  '3d':         { label: '3D Models',    color: 'text-cyan-600',    gradient: 'from-cyan-500 to-blue-500' },
  webpage:      { label: 'Webpages',     color: 'text-blue-600',    gradient: 'from-blue-500 to-sky-500' },
  subtitle:     { label: 'Subtitles',    color: 'text-gray-600',    gradient: 'from-gray-500 to-slate-500' },
  certificate:  { label: 'Certificates', color: 'text-yellow-600',  gradient: 'from-yellow-500 to-amber-500' },
  medical:      { label: 'Medical',      color: 'text-red-600',     gradient: 'from-red-500 to-rose-500' },
  scientific:   { label: 'Scientific',   color: 'text-purple-600',  gradient: 'from-purple-500 to-violet-500' },
  'disk-image': { label: 'Disk Images',  color: 'text-zinc-600',    gradient: 'from-zinc-500 to-gray-500' },
};
