...
import ImageResizerUI from "@/components/Tools/image/ImageResizerUI";
...
const trustFeatures = [
  { label: "100% Private", desc: "Files never leave your device" },
  { label: "Instant", desc: "In-browser processing" },
  { label: "No Account", desc: "No sign-up required" },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <section className="py-14 lg:py-20">
        <div className="container mx-auto px-4">
          ...
          <ImageResizerUI toolName={config.name} />
      ...
      <UniversalLandingExtras
        variant="tool"
        locale={locale}
        toolKey={`image-resizer/${subpath}`}
        toolName={config.name}
        toolMode="image"
        toolParentPath="image-resizer"
        toolParentLabel="Image Resizer"
        category="image"
      />
    </div>
  );
