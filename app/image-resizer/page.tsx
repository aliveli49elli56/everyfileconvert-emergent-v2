...
const tools = [
  ...
  },
  {
    ...
    icon: Minimize2,
    href: "/image-resizer/batch",
    color: "from-emerald-500 to-teal-500",
  },
  {
    name: "Scale by Percentage",
    description: "Scale images proportionally by percentage",
    icon: Scale,
    href: "/image-resizer/scale",
    color: "from-violet-500 to-purple-500",
  },
  {
    name: "Smart Crop",
    description: "AI-powered cropping with content detection",
    icon: Crop,
    href: "/image-resizer/smart-crop",
    color: "from-rose-500 to-pink-500",
    new: true,
  },
  {
    name: "Square Format",
    description: "Convert to 1:1 aspect ratio for social media",
    icon: SquareIcon,
    href: "/image-resizer/square",
    color: "from-amber-500 to-orange-500",
  },
  {
    name: "Landscape Format",
    description: "Convert to 16:9 or 4:3 aspect ratio",
    icon: RectangleHorizontal,
    href: "/image-resizer/landscape",
    color: "from-blue-500 to-indigo-500",
  },
  {
    name: "Portrait Format",
    description: "Convert to 9:16 or 3:4 aspect ratio",
    icon: RectangleVertical,
    href: "/image-resizer/portrait",
    color: "from-teal-500 to-cyan-500",
  },
  {
    name: "AI Upscaler",
    description: "Increase resolution with AI enhancement",
    icon: Sparkles,
    href: "/image-converter/upscale",
      ...
      <section className="py-16 lg:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <Badge
              variant="secondary"
              className="mb-4 px-3 py-1 bg-cyan-100 text-cyan-700 border-cyan-200"
            >
              Image Tools
            </Badge>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {tool.popular && (
                            <Badge
                              variant="secondary"
                              className="text-xs bg-cyan-100 text-cyan-700 border-cyan-200"
                            >
                              Popular
                            </Badge>
                          )}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {presets.map((preset) => (
                <div
                  key={preset.name}
                  className="p-4 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition-all cursor-pointer"
                >
